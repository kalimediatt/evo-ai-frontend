...
export function AgentInfo({ agent, apiKey }: AgentInfoProps) {
          ...
          <div className="p-4 space-y-4 border-t border-[#1e3a36] animate-in fade-in-50 duration-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#141414] rounded p-3 flex flex-col justify-between">
                <span className="text-xs text-gray-500 mb-1">Model</span>
              ...
              <div className="bg-[#141414] rounded p-3 flex flex-col justify-between">
                <span className="text-xs text-gray-500 mb-1">Created at</span>
                <div className="flex items-center gap-2">
          ...
          <div className="mt-4">
            {agent.agent_card_url && (
              <iframe
                ...
                className="w-full h-[50vh] border border-[#333] rounded-md"
              />
            )}
          </div>
