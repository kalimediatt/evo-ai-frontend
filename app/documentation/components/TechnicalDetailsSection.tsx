...
export function TechnicalDetailsSection({ copyToClipboard }: TechnicalDetailsSectionProps) {
  return (
    <Card className="bg-[#1a1a1a] border-[#333] text-white">
      <CardHeader>
        <CardTitle className="text-[#00ff9d]">Technical Details of the Methods</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          <h3 className="text-[#00ff9d] text-lg font-medium mb-2">Method tasks/send</h3>
...
x-api-key: YOUR_API_KEY`)}
        ...
        <div>
          <h3 className="text-[#00ff9d] text-lg font-medium mb-2">Method tasks/sendSubscribe</h3>
          <p className="text-gray-300 mb-4">
...
`)}
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
                <li><span className="text-[#00ff9d]">Status Updates</span>: Contains the <code className="bg-[#333] px-1 rounded">status</code> field with information about the task status.</li>
                <li><span className="text-[#00ff9d]">Artifact Updates</span>: Contains the <code className="bg-[#333] px-1 rounded">artifact</code> field with the content generated by the agent.</li>
                <li><span className="text-[#00ff9d]">Ping Events</span>: Simple events with the format <code className="bg-[#333] px-1 rounded">: ping</code> to keep the connection active.</li>
              </ul>
            </div>
  ...
  eventSource.close();
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-1">
                <li><span className="text-[#00ff9d]">submitted</span>: Task sent but not yet processed</li>
                <li><span className="text-[#00ff9d]">working</span>: Task being processed by the agent</li>
                <li><span className="text-[#00ff9d]">completed</span>: Task completed successfully</li>
                <li><span className="text-[#00ff9d]">input-required</span>: Agent waiting for additional user input</li>
                <li><span className="text-[#00ff9d]">failed</span>: Task failed during processing</li>
                <li><span className="text-[#00ff9d]">canceled</span>: Task was canceled</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#222] p-4 rounded-md border border-[#444]">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <li className="flex items-center">
              ...
              <span className="text-gray-300"><strong>submitted</strong>: Task sent</span>
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 bg-yellow-500 rounded-full mr-2"></span>
              <span className="text-gray-300"><strong>working</strong>: Task being processed</span>
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 bg-purple-500 rounded-full mr-2"></span>
              <span className="text-gray-300"><strong>input-required</strong>: Agent waiting for additional user input</span>
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 bg-green-500 rounded-full mr-2"></span>
              <span className="text-gray-300"><strong>completed</strong>: Task completed successfully</span>
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 bg-gray-500 rounded-full mr-2"></span>
              <span className="text-gray-300"><strong>canceled</strong>: Task canceled</span>
            </li>
            <li className="flex items-center">
              <span className="w-3 h-3 bg-red-500 rounded-full mr-2"></span>
              <span className="text-gray-300"><strong>failed</strong>: Task processing failed</span>
            </li>
          </ul>
        </div>
      </CardContent>
